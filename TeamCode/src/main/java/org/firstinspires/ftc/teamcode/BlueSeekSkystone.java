...
@Autonomous (name = "BlueSeekSkystone", group = "12806") // drive to bridge via SkyStone path
//@Autonomous (name = "RedSeekSkystone_Wall", group = "12806") // drive to bridge via wall path

public class BlueSeekSkystone extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.strafeRightByTime(0.25,1200); // try to center robot in front of Skystone.  power of .1 is too low.
